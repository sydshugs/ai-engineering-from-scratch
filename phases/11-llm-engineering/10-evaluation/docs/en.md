...
- [LMArena (formerly LMSYS Chatbot Arena)](https://lmarena.ai/) -- live human evaluation platform where users vote on model outputs, the largest pairwise comparison dataset for LLMs
