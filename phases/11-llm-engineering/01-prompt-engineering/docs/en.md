...
- [LMArena (formerly LMSYS Chatbot Arena)](https://lmarena.ai/) -- live blind comparison of LLMs where you can test the same prompt across models and vote on which response is better
