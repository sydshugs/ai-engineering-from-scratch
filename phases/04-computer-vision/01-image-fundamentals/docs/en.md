...
- [Charles Poynton — Color FAQ](https://poynton.ca/ColorFAQ.html) — the clearest technical treatment of why there are so many color spaces and when each one matters
