...
- [Carvana Image Masking Challenge (Kaggle)](https://www.kaggle.com/competitions/carvana-image-masking-challenge) — a walkthrough of why TTA, pseudo-labeling, and class weights matter on real data
