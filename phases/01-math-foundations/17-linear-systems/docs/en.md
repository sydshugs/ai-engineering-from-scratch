...
- [Matrix Computations](https://www.hfsbooks.com/books/matrix-computations-4th-edition-golub-van-loan/) (Golub & Van Loan) -- the encyclopedic reference for every matrix algorithm
